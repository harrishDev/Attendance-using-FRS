...
window = tk.Tk()
window.title("Automated Attendance Management System Using Face Recognition With LBPH Algorithm")
    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='localhost', user='system', password='aazam9', db='manually_fill_attendance')
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'D:\other fellows\Face-Recognition-Attendance-System\Attendance\Manually Attendance'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"D:\other fellows\Face-Recognition-Attendance-System\Attendance\Manually Attendance"')
...
def subjectchoose():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    global cursor
                    connection = pymysql.connect(
                        host='localhost', user='system', password='aazam99', db='Face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                ...
                root.configure(background='grey80')
                cs = 'D:\other fellows\Face-Recognition-Attendance-System' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"D:\other fellows\Face-Recognition-Attendance-System\Attendance"')
    ...
    def log_in():
        ...
        if username == 'system':
            if password == 'system':
                ...
                cs = 'D:\other fellows\Face-Recognition-Attendance-System\StudentDetails\StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
message = tk.Label(window, text=" Automated Attendance Management System Using Face Recognition With LBPH Algorithm ", bg="green", fg="white", width=66,
                   height=3, font=('times', 21, ' bold '))
